    ...
    RestClient.get(
      ...
      function (response) {
        ...
        comments.forEach(function (comment) {
          const username = Utils.escapeHtml(comment.username || 'Anonymous');
          ...
          html += `
            <div class="single-comment-item" style="margin-bottom:30px; overflow:hidden;">
              <div class="sc-author" style="float:left; margin-right:20px;">
                <img
                  src="https://ui-avatars.com/api/?name=${encodeURIComponent(comment.username || 'Anonymous')}&size=70&background=dd1515&color=fff"
                  alt="${username}"
